...
def main():
    ...
    # Top level data directory. ImageFolder structure
    data_dir = "images"
    ...
    # Flag for feature extracting. False - finetune the whole model True - update the reshaped layer params
    ...
    print("Model is being trained with ", device)
